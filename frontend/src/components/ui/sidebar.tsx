        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))] group-data-[collapsible=icon]:p-2",
            className
          )}
          {...props}
        >
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Largeur fixe pour le skeleton — on évite Math.random qui est impur à l'affichage
  const width = '70%'
  return (
...
// Expose cookie constants for use in layout
