 ...
 * Usage: pnpm seed   (reads apps/app/.env.local automatically)
 *
 * Creates:
...
require('dotenv').config({ path: path.join(__dirname, '..', 'apps', 'app', '.env.local') });
...
if (!SUPABASE_URL || !SERVICE_KEY) {
  console.error('\n❌  Missing env vars. Make sure apps/app/.env.local has:');
